...
fuel1.add_nuclide('Th232',35.152,percent_type='wo' )
fuel1.add_nuclide('U235',2.613,percent_type='wo' )
fuel1.add_nuclide('U238',50.2743,percent_type='wo' )
fuel1.add_nuclide('O16',11.961,percent_type='wo' )
fuel1.deplete = True
...
fuel1.volume = math.pi * 36 * 264 * 0.4096 ** 2
fuel2.volume = math.pi * 21 * 264 * 0.4096 ** 2
