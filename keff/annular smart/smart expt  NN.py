...
# Create the cell for the material inside the cladding
ic_fuel2 = openmc.Cell(region = -ic_rad,fill = moderator)
icl_fuel2 = openmc.Cell(region = +ic_rad & -icl_rad ,fill = clad1)
ig_fuel2 = openmc.Cell(region = +icl_rad & -ig_rad,fill = helium)
fuel_fuel2 = openmc.Cell(name='fuel2',region = +ig_rad & -pin_rad,fill = fuel2)
...
# Finally add the cells we just made to a Universe object
u2= openmc.Universe()
u2.add_cells([ic_fuel2,icl_fuel2,ig_fuel2,fuel_fuel2,helium_fuel2,clad_fuel2,mod_fuel2])

# Create the cells which will be used to represent each pin type.

# Create the cell for the material inside the cladding
ic_fuel3 = openmc.Cell(region = -ic_rad,fill = moderator)
icl_fuel3 = openmc.Cell(region = +ic_rad & -icl_rad ,fill = clad1)
ig_fuel3 = openmc.Cell(region = +icl_rad & -ig_rad,fill = helium)

fuel_fuel3  = openmc.Cell(name='fuel3',region = +ig_rad & -pin_rad ,fill = IFBA)


helium_fuel3= openmc.Cell(name='helium',region = +pin_rad & -clad_in,fill = helium)


clad_fuel3 = openmc.Cell(name='clad1',region = +clad_in & -clad_out,fill = clad1)


mod_fuel3 = openmc.Cell(name='moderator',region = +clad_out,fill = moderator)


# Finally add the cells we just made to a Universe object
u3 = openmc.Universe()
u3.add_cells([ic_fuel3,icl_fuel3,ig_fuel3,fuel_fuel3,helium_fuel3,clad_fuel3,mod_fuel3])
...
[u1, u1, g, u1, u1, g, u1, u1, g, u1, u1, g, u1, u1, g, u1, u1],
[u1, u1, u1, u1, u3, u1, u1, u1, u1, u1, u1, u1, u3, u1, u1, u1, u1],
[u1, u3, u1, u1, u1, g, u1, u3, g, u3, u1, g, u1, u1, u1, u3, u1],
[u1, u1, u1, u1, u1, g, u1, u1, g, u1, u1, g, u1, u1, u1, u1, u1],
[u1, u1, u1, u3, u1, u1, u1, u1, u1, u1, u1, u1, u1, u3, u1, u1, u1],
[u1, u1, u1, u1, u1, u1, u1, u1, u1, u1, u1, u1, u1, u1, u1, u1, u1]]
# Create a containing cell and universe
