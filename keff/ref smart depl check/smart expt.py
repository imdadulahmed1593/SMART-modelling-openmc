...
fuel1.volume = math.pi * 9040 * 0.4096 ** 2
fuel2.volume = math.pi * 5328* 0.4096 ** 2
IFBA.volume = math.pi * 680 * 0.4096 ** 2
#fuel1.volume = math.pi * 0.4096 ** 2
#fuel2.volume = math.pi * 0.4096 ** 2

#depletion chain specification
#chain = openmc.deplete.Chain.from_xml("./chain_endfb71.xml")
operator = openmc.deplete.Operator(geometry, settings_file,"./chain_casl_pwr.xml")
power = 330e6  # W/cm
