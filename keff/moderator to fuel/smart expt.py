...
empty_plane1=openmc.XPlane(x0=9.435)
empty_plane2=openmc.YPlane(y0=9.435)
empty_plane3=openmc.XPlane(x0=-9.435)
empty_plane4=openmc.YPlane(y0=-9.435)
cells={}
universes={}
...
lattices2['UO2 Assembly'].lower_left = [-9.435, -9.435]
lattices2['UO2 Assembly'].pitch = [1.11, 1.11]
...
lattices3['UO2 Assembly'].lower_left = [-9.435, -9.435]
lattices3['UO2 Assembly'].pitch = [1.11, 1.11]
...
lattices4['UO2 Assembly'].lower_left = [-9.435, -9.435]
lattices4['UO2 Assembly'].pitch = [1.11, 1.11]
...
lattices5['UO2 Assembly'].lower_left = [-9.435, -9.435]
lattices5['UO2 Assembly'].pitch = [1.11, 1.11]
...
lattices6['UO2 Assembly'].lower_left = [-9.435, -9.435]
lattices6['UO2 Assembly'].pitch = [1.11, 1.11]
...
lattices7['UO2 Assembly'].lower_left = [-9.435, -9.435]
lattices7['UO2 Assembly'].pitch = [1.11, 1.11]
...
lattices['Core'].lower_left = [-84.915, -84.915]
lattices['Core'].pitch = [18.87, 18.87]
...
# Create root Cell
core_os=openmc.ZCylinder(r=90,boundary_type='reflective')
...
mesh.lower_left = [-32.13, -9.435]
mesh.upper_right=[+9.435,+32.13]
